...
| --- | --- | --- |
| [Cobalt](https://github.com/imputnet/cobalt) | Facebook, Instagram, TikTok and YouTube integration | Official image 11.7.1; Instagram plus no-cookie YouTube MP4/MP3 tested locally |
...
Other posts and media types, Facebook and TikTok live links, restricted YouTube videos, future anonymous visibility, media bandwidth cost, real iOS/Android saves, and production hosting remain unverified. No success-rate or unlimited-access claim is made. See [verification](verification.md).
