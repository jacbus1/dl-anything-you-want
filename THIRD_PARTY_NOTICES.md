...
| whisper.cpp 1.9.4 + ggml-tiny multilingual model | Built into the Docker application image for local speech-to-text | [MIT license and model information](https://github.com/ggml-org/whisper.cpp) |
